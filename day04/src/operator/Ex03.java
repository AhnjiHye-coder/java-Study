...
public class Ex03 {
	public static void main(String[] args) {
		// 삼항 연산자
		// A ? B : C
		// A조건이 참이면 B값으로 결정하고 아니라면 C 값으로 결정한다
		// 조건에 따라 서로 다른 값 중 하나를 결정짓는 연산자
		
		// if는 조건에 따라서 서로 다른 코드를 수행하는 것이 목적(행위)
		// 삼항 연산자는 두개의 값 중 하나를 결정 짓는 것이 목적 (값)
		...
		String oddEven = num == 0 // num이 0이면
							? "Zero"	// Zero를 대입
							: num % 2 == 0	// 만약 num이 2로 나누어 떨어지면
								? "짝수"		// 짝수를 대입
								: "홀수";		// 아니면 홀수를 대입
		System.out.println("oddEven : " + oddEven);
		
		// 잘못된 예시
		// 이유 : 바로 출력을 원하지 말고 값을 대입해서 결과를 얻어야 한다
		//num %  2 == 0 ? System.out.println("짞수") : System.out.println("홀수");
	...
	// 문자열의 글자를 모두 숫자로만 구성되어있는지 검사하여 결과를 boolean으로 반환하는 함수
