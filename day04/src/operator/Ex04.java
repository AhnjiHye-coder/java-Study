...
public class Ex04 {
	public static void main(String[] args) {
		...
		Scanner sc = new Scanner(System.in); // 키보드로 입력 받아서 처리하는 객체
		
		int n1 = ran.nextInt(9) + 1;
		int n2 = ran.nextInt(9) + 1;
//		Integer answer = null; 이렇게 해도 되지만
