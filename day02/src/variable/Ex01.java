...
public class Ex01 {
	public static void main(String[] args) {
		...
		// 변수를 주소로 직접 참조하면 포인터(자바에소는 사용하지 않는다) 
		// 변수를 이름으로 참조하면 (reference)
		
		// 변수를 생성하기 위해서는 자료형을 명시해야 한다(변수의 선언)
		// 이미 선언된 변수는 이름만으로 참조가 가능하다
		...
		System.out.println(num);	// 선언된 변수는 이름만으로도 참조할 수 있다
		System.out.println(num2);
		
//		int num = 25; 	// 이미 선언된 변수는 자료형을 명시하지 않는다
						// 새로운 변수를 만들기 위해서는 기존 변수와 이름이 겹쳐지지 않아야 한다
		
		num2 = num;		// 대입연산자의 좌변은 공간
						// 대입연산의 우변은 값
						// 우변부터 먼저 처리한다
